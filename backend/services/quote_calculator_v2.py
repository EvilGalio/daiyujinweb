...
def _looks_like_email(email: str) -> bool:
    ...
    return bool(local and sep and domain and "." in domain and " " not in email)
...
def public_quote_response(result: dict) -> dict:
    ...
    return {
        ...
        "disclaimer": "This reference estimate is generated by our AI-assisted quoting system, which is continuously learning from manufacturing data. At this stage, the price is for reference only. For accurate pricing, please request a formal quote.",
    }
