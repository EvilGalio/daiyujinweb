...
class PortalOrder(Base):
    ...
    status: Mapped[str] = mapped_column(String(20), default="active")
    manual_status: Mapped[str] = mapped_column(String(20), default="normal")
    ...
    complaint_status: Mapped[str | None] = mapped_column(String(40))
    complaint_opened_at: Mapped[datetime | None] = mapped_column(DateTime)
    complaint_resolved_at: Mapped[datetime | None] = mapped_column(DateTime)
    created_by_user_id: Mapped[int | None] = mapped_column(Integer)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
