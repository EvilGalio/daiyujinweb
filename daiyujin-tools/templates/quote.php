        ...
        <main>
            ...
            <section class="quote-workspace is-empty" data-quote-workspace>
                <aside class="tool-panel quote-parts-rail" data-batch-parts hidden>
                    <div class="quote-batch-head"><h2>Parts</h2><span data-batch-count>0 files</span></div>
                    <div class="quote-batch-progress" data-batch-progress hidden>
                        <div class="quote-batch-progress-copy">
                            <strong data-batch-progress-label>Preparing analysis</strong>
                            <span class="quote-network-state" data-network-status hidden>Reconnecting</span>
                        </div>
                        <div class="quote-batch-progress-track" role="progressbar" aria-label="CAD analysis progress" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" data-batch-progressbar>
                            <span data-batch-progress-fill></span>
                        </div>
